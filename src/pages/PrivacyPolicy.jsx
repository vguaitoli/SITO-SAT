...
export default function PrivacyPolicy() {
  ...
  const content = LEGAL_CONTENT[locale].privacy;
  const { legale } = SITE;
  ...
  return (
    <div className="min-h-screen bg-[#1C1814] topo-dark">
      ...
      <main className="mx-auto max-w-3xl px-5 pb-16 pt-32 lg:px-8 lg:pb-24 lg:pt-40">
        ...
        <Link to={href("/#contatti")} className="btn-mech mt-4 inline-flex bg-[#A0612A] px-8 py-4 text-base text-[#F5EBD9] hover:bg-[#b87033]">
          {content.cta}
        </Link>
      </main>
      <Footer />
