    ...
    <section className="bg-[#F5EBD9] topo-bg py-24 lg:py-32 border-y border-[#1C1814]/10">
      <div className="max-w-5xl mx-auto px-5 lg:px-8">
        <div className="text-center mb-16">
          <p className="font-button text-[#A0612A] text-xs tracking-[0.3em] uppercase mb-4">Trasparenza totale</p>
          ...
          {includes.map((item, i) => {
            ...
            return (
              <div
                ...
                <span className="font-button text-2xl text-[#A0612A]/40 w-8 tabular-nums">
